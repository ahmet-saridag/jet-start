...
export default function SignUpPage() {
  ...
  useEffect(() => {
    const intervalId = setInterval(() => {
      const emailInput: HTMLInputElement | null = document.querySelector('.cl-formFieldInput__emailAddress');
      const passwordInput: HTMLInputElement | null = document.querySelector('.cl-formFieldInput__password');
